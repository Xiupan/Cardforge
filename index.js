...
// app.get('/muckdispatcher/hourFilter/0', function(req, res){
//   res.sendFile(path.join(__dirname, '/public/mucked0.html'));
// })
//
// app.get('/muckdispatcher/hourFilter/1', function(req, res){
//   res.sendFile(path.join(__dirname, '/public/mucked1.html'));
// })
//
// app.get('/muckdispatcher/hourFilter/2', function(req, res){
//   res.sendFile(path.join(__dirname, '/public/mucked2.html'));
// })
//
// app.get('/muckdispatcher/hourFilter/3', function(req, res){
//   res.sendFile(path.join(__dirname, '/public/mucked3.html'));
// })
//
// app.get('/muckdispatcher/hourFilter/4', function(req, res){
//   res.sendFile(path.join(__dirname, '/public/mucked4.html'));
// })
//
// app.get('/muckdispatcher/hourFilter/5', function(req, res){
